...
def plot_roc_curve(y_test: np.ndarray, y_prob: np.ndarray, model_name: str) -> plt.Figure:
    """Plot ROC curve."""
...
def plot_confusion_matrix(y_test: np.ndarray, y_pred: np.ndarray, model_name: str) -> plt.Figure:
