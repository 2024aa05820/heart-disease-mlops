...
class HeartDiseasePredictor:
    ...
    def predict_batch(self, features_list: List[Dict[str, Union[int, float]]]) -> List[Dict[str, any]]:
        """
...
FEATURE_SCHEMA = {
    ...
    "sex": {"type": "int", "min": 0, "max": 1, "description": "Sex (1 = male, 0 = female)"},
    "cp": {"type": "int", "min": 0, "max": 3, "description": "Chest pain type (0-3)"},
    "trestbps": {"type": "int", "min": 50, "max": 250, "description": "Resting blood pressure (mm Hg)"},
    "chol": {"type": "int", "min": 100, "max": 600, "description": "Serum cholesterol (mg/dl)"},
    "fbs": {"type": "int", "min": 0, "max": 1, "description": "Fasting blood sugar > 120 mg/dl"},
    "restecg": {"type": "int", "min": 0, "max": 2, "description": "Resting ECG results (0-2)"},
    "thalach": {"type": "int", "min": 50, "max": 250, "description": "Maximum heart rate achieved"},
    "exang": {"type": "int", "min": 0, "max": 1, "description": "Exercise induced angina"},
    "oldpeak": {"type": "float", "min": 0, "max": 10, "description": "ST depression induced by exercise"},
    "slope": {"type": "int", "min": 0, "max": 2, "description": "Slope of peak exercise ST segment"},
    "ca": {"type": "int", "min": 0, "max": 4, "description": "Number of major vessels (0-4)"},
